				...
				<div
					...
					<form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/login">
						<div class="form-group">
							<label for="username" class="col-sm-2 control-label" style="width:17.666667%;">用户名</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="inputPassword3" class="col-sm-2 control-label" style="width:17.666667%;">密码</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="inputPassword3" class="col-sm-2 control-label" style="width:17.666667%;">验证码</label>
							<div class="col-sm-3">
